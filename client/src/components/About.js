  ...
  return (
    <div className='py-10'>
      ...
      <ul>
        ...
        <li>Washers and Centrifugal Extractors</li>
        <li>Batch Washers, Components, and Systems</li>
        <li>Stonewash & Garment Dye Machines</li>
        <li>Dryers and Lint Traps</li>
        <li>Ironers</li>
        <li>Flatwork Feeders/Folders and Small Piece Folders</li>
        <li>Garment Finishing Tunnels and Pressing Equipment</li>
        <li>Material Handling</li>
        <li>Air Compressors</li>
        <li>Boilers and Water Heating Systems</li>
        <li>Wastewater</li>
        <li>Parts</li>
        <li>Carts</li>
      </ul><br />
      <p>In addition, The Laundry List is the perfect venue for locating desired equipment at a price that fits your budget. Even if you do not see the equipment you want on the list, please contact us first. We are in constant communication with companies all over North America who may be looking to sell what you need. And, on the other hand, if you are looking to sell, our catalog is the perfect venue to reach the masses both quickly and more importantly, effectively.</p><br />
      <p>With our headquarters located in Los Angeles, CA we also have offices and/or warehousing in Las Vegas, NV, Atlanta, GA, and soon to be St. Louis, MO.  In addition, we also have sales associates in Eastern Canada as well as South America.</p><br />
